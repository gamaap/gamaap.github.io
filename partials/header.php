<!-- HEADER MENU -->
<header class="fixed inset-x-0 top-0 z-50 bg-white/70 backdrop-blur-md shadow-md transition duration-300">
  <nav
    ...
    <div class="hidden lg:flex lg:flex-1 justify-end">
      <nav class="flex gap-x-10">
        ...
        <a
          ...
          >Contact</a
        >
        <a href="career.php" class="text-sm/6 font-semibold text-gray-900"
          >Career</a
        >
