...
<main class="mb-auto pt-20">
  ...
  <section class="container mx-auto sm:px-44 pt-20 mt-8">
    <div class="w-full rounded-xl overflow-hidden shadow-lg">
      <div
        ...
        style="background-image: url(/assets/hero/2.png)"
      >
          ...
          <div class="text-left">
            <div class="container mx-auto">
              <div class="max-w-4xl mx-auto text-left">
                <h2
                  class="text-4xl font-extrabold tracking-wide text-yellow-500 shadow-text sm:text-4xl uppercase px-4 py-2 mt-8 rounded-lg"
  ...
  <div class="bg-white py-24 sm:py-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div
        class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 mb-8 mx-64"
      >
        <button
          class="category-button bg-gray-200 text-center py-4 px-13 rounded shadow hover:bg-gray-300 hover:text-yellow-500 focus:text-yellow-500 transition"
        >
          Exhibition
        </button>
        <button
    ...
    <!-- PAGINATION -->
    <div
      class="flex items-center justify-between border-t border-gray-200 bg-white px-4 mt-10 py-3 sm:px-6"
    >
